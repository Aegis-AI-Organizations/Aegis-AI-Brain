...
async def test_update_scan_status_success(scan_service):
    ...
    with patch("grpc_services.internal_auth.InternalAuthService._verify_token_db_sync") as mock_verify, \
         patch("grpc_services.scans.ScanService._get_scan_status_db") as mock_get_status, \
         patch("grpc_services.scans._execute_status_update") as mock_execute:
