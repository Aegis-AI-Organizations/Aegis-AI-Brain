# Graph Report - Aegis-AI-Brain  (2026-07-17)

## Corpus Check
- 106 files · ~38,652 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1244 nodes · 1958 edges · 112 communities (99 shown, 13 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 308 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d574e104`
...
### Community 7 - "$ref"
Cohesion: 0.10
Nodes (26): items, type, items, type, items, type, items, type (+18 more)
...
Cohesion: 0.16
Nodes (12): datetime, DeclarativeBase, Base, Modern SQLAlchemy declarative base for all models., Evidence, Scan model mapped to the 'scans' table., Vulnerability model mapped to the 'vulnerabilities' table., Evidence model mapped to the 'evidences' table. (+4 more)
...
### Community 23 - "Base"
Cohesion: 0.17
Nodes (12): type, externalRoute, additionalProperties, properties, type, $ref, type, type (+4 more)
...
Cohesion: 0.18
Nodes (9): _artifact_payload(), download_minio_artifact(), parse_minio_reference(), main(), start_worker(), test_artifact_payload_maps_topology_json_to_sandbox_request(), test_download_minio_artifact_reads_object_and_returns_deployable_payload(), test_parse_minio_reference_supports_explicit_and_default_bucket() (+1 more)

### Community 41 - "update_scan_status"
Cohesion: 0.12
Nodes (22): _execute_generate_and_store_pdf_report(), _execute_status_update(), generate_and_store_pdf_report(), Internal helper to execute the SQL update., Generates PDF bytes in memory and stores them in scans.report_pdf., Generates a structured PDF report in memory and stores it in scans.report_pdf., Updates the status of a specific scan in the PostgreSQL database., update_scan_status() (+14 more)
...
### Community 46 - "$defs"
Cohesion: 0.25
Nodes (8): type, additionalProperties, type, $defs, databaseColumn, stringMap, additionalProperties, type

### Community 47 - "properties"
Cohesion: 0.22
Nodes (9): type, properties, type, type, type, data_type, default_value, nullable (+1 more)
...
Cohesion: 0.17
Nodes (12): additionalProperties, properties, type, databaseForeignKey, minLength, type, name, referenced_columns (+4 more)
...
Cohesion: 0.14
Nodes (7): Company, Company model mapped to the 'companies' table., test_create_user_success(), test_revoke_agent_token_success_for_owner(), test_rotate_agent_token_success_for_owner(), test_list_companies_owner_visibility(), test_list_users_owner_visibility()
...
Cohesion: 0.27
Nodes (6): items, type, empty_dirs, secret_files, items, type
...
Cohesion: 0.60
Nodes (4): serve(), test_grpc_server_mtls_fails_when_certificate_missing(), test_grpc_server_mtls_requires_client_certificate(), test_grpc_server_serve_registration()
...
Cohesion: 0.50
Nodes (4): initContainer, additionalProperties, required, type

### Community 93 - "databaseName"
Cohesion: 0.50
Nodes (4): workload, additionalProperties, required, type
...
### Community 109 - "init_containers"
Cohesion: 0.67
Nodes (3): items, type, init_containers
...
- **Why does `AuthService` connect `CompanyService` to `User`, `AuthService`, `OnboardingInvitation`, `.Logout`, `.Refresh`, `test_auth_service.py`, `.SetupPassword`, `.GetMe`, `.RemoveAvatar`, `.UpdateEmail`, `.UpdatePassword`, `.UpdateProfile`, `download_minio_artifact`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `AgentService` connect `AgentService` to `get_session_factory`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `$defs` connect `$defs` to `sandbox-topology.schema.json`, `properties`, `databaseSchema`, `name`, `properties`, `service`, `columns`, `properties`, `Base`, `.WatchCompanyUpdates`, `properties`, `databaseName`, `externalMock`, `properties`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
